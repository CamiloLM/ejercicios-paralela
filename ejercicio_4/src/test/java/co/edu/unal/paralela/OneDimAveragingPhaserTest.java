...
public class OneDimAveragingPhaserTest extends TestCase {
  // Número de veces para repetir cada test, para lograr resultados consistentes
  // en el tiempo.
  ...
  /**
   * Una implmenetación de referencia de runSequential, en caso de que se
   * modifique accidentalmente el código fuente.
   */
   ...
   * @return La mejora en rapidez lograda, No todas las pruebas utilizan esta
   *         información
   */
